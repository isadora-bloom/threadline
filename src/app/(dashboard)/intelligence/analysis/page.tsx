...
// ── Threads Tab — shows investigative leads from deep research ──────────────
...
function ThreadsTab() {
  ...
  const updateStatus = async (id: string, status: string) => {
    ...
    queryClient.invalidateQueries({ queryKey: ['research-leads'] })
  }
  ...
  return (
    <div className="space-y-2">
      <p className="text-xs text-slate-500 mb-3">
        Leads generated by Threadline AI deep research. Each one is an investigative thread to follow.
      </p>
      {leads.map((lead) => {
